...
import com.xht.lease.exception.LeaseException;
import com.xht.lease.mapper.ApartmentInfoMapper;
import com.xht.lease.result.ResultCodeEnum;
import com.xht.lease.service.*;
...
public class ApartmentInfoServiceImpl extends ServiceImpl<ApartmentInfoMapper, ApartmentInfo>
    ...
    public IPage<ApartmentItemVo> pageApartmentItemByQuery(IPage<ApartmentItemVo> page, ApartmentQueryVo queryVo) {
        return this.baseMapper.pageApartmentItemByQuery(page, queryVo);
    }
    ...
    public ApartmentDetailVo getApartmentDetailById(Long id) {
        ...
        //4.查询FacilityInfo
        List<FacilityInfo> facilityInfoList = apartmentFacilityService.selectListByApartmentId(id);
